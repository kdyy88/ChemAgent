...
<CodeBlock
  language="bash"
  code={`pnpm dlx shadcn@latest add "https://prompt-kit.com/c/[COMPONENT].json"`}
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/prompt-input.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/code-block.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/markdown.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/message.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/chat-container.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/scroll-button.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/loader.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/prompt-suggestion.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/response-stream.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/reasoning.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/file-upload.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/jsx-preview.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/tool.json"`}
  language="bash"
/>
...
<CodeBlock
  code={`pnpm dlx shadcn add "https://prompt-kit.com/c/source.json"`}
  language="bash"
/>
...
**Installation**:
```bash
pnpm dlx shadcn add "https://prompt-kit.com/c/chatbot.json"
```
...
**Installation**:
```bash
pnpm dlx shadcn add "https://prompt-kit.com/c/tool-calling.json"
```
