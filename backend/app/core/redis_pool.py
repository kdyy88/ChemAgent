"""
Redis connection pool and configuration.

Provides ARQ and plain Redis client singletons plus all environment-driven
config helpers.  Extracted from core/task_queue.py which re-exports for
