"""
task_runner/bridge — smart task execution with Redis/ARQ + in-process fallback.

Canonical location.  app/core/task_bridge.py re-exports for backward compatibility.
"""
...
from app.domain.store.artifact_store import delete_task_result, read_task_result
