"""
task_runner/registry — task-name → callable mapping.

Canonical location.  app/core/task_registry.py re-exports for backward compatibility.

Imported by:
  app/services/task_runner/bridge.py  (direct fallback when Redis is unavailable)
  app/services/task_runner/worker.py  (ARQ worker dispatch table)
