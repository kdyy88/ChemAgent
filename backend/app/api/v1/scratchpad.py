"""GET /api/v1/scratchpad/{scratchpad_id}
...
from app.domain.store.scratchpad_store import read_scratchpad_entry
from app.domain.schemas.api import ScratchpadResponse
